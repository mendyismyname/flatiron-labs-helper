...
function rb {
  cd /Users/$USER/Development/code/flatiron/ruby/$@
}

function js {
  cd /Users/$USER/Development/code/flatiron/javascript/$@
}
...
function testing {
  regex='[^/]+(?=/$|$)'
  echo "/use/dkja" |  grep -o '/usr.*'
}

function sql {
  cd /Users/$USER/Development/code/flatiron/sql/$@
}
